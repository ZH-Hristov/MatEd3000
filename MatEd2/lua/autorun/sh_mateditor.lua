...
function advMats:Set(ent, texture, data, submatid)
	if (SERVER) then
		...
		local uid = texture .. "+" .. (data.ScaleX or 1) .. "+" .. (data.ScaleY or 1) .. "+" .. (data.OffsetX or 0) .. "+" .. (data.OffsetY or 0) .. "+" .. (data.Rotate or 0) .. "+" .. (data.AlphaType or 0) .. "+" .. (data.NoCull or 0) .. "+" .. (data.IgnoreZ or 0)
		...
		if (data.UseBump) then
			uid = uid .. (data.BumpTexture) .. "+" .. (data.UseSSBump)
		end
		...
		data.UseSSBump = data.UseSSBump or 0
		...
		data.IgnoreZ = data.IgnoreZ or 0
		...
		local uid = texture .. "+" .. data.ScaleX .. "+" .. data.ScaleY .. "+" .. data.OffsetX .. "+" .. data.OffsetY .. "+" .. data.Rotate  .. "+" .. data.AlphaType .. "+" .. data.NoCull  .. "+" .. tonumber(data.IgnoreZ)
		...
		ent["MaterialData"..submatid] = {
			...
			NoiseRotate = data.NoiseRotate or 0,
			UseBump 	= data.UseBump or false,
			UseSSBump = data.UseSSBump or false,
			BumpTexture = data.BumpTexture or "",
			UseLightwarp = data.UseLightwarp or false,
			LightwarpTexture = data.LightwarpTexture or "",
			UseEnvMap 	= data.UseEnvMap or false,
